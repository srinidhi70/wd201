...
describe("Tests for functions in todo.js", () => {
  ...
  describe("Todo.overdue", () => {
    test("should return all tasks (including completed ones) that are past their due date", async () => {
  ...
  describe("Todo.dueToday", () => {
    test("should return all tasks that are due today (including completed ones)", async () => {
  ...
  describe("Todo.dueLater", () => {
    test("should return all tasks that are due on a future date (including completed ones)", async () => {
